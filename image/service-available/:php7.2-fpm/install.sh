...
sed -i -e "s/max_execution_time.*/max_execution_time = 90/g" /etc/php/7.2/fpm/php.ini

sed -i -e "s/error_log = .*/error_log = \/proc\/self\/fd\/2/g" /etc/php/7.2/fpm/php-fpm.conf
...
sed -i -e "s/;catch_workers_output = yes/catch_workers_output = yes/g" /etc/php/7.2/fpm/pool.d/www.conf
sed -i -e "s/pm =.*/pm = ondemand/g" /etc/php/7.2/fpm/pool.d/www.conf
